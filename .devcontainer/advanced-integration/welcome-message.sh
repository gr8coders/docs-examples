...
WELCOME_MESSAGE="
👋 Welcome to the \"Advanced Checkout Integration Example\"
...
mkdir -p $HOME/.config/vscode-dev-containers/ && touch $HOME/.config/vscode-dev-containers/first-run-notice.txt
